        ...
        SwipeRefresh(
            ...
            val settingsUnits = listOf(
                SettingsUnit.SettingsUnit(
                    title = stringResource(id = R.string.settings_title_general_settings),
                    settingsComposable = listOf(
                        {
                            SettingsUnit.SwitchUnit(
                                title = stringResource(id = R.string.settings_title_auto_save_history),
                        ...
                        },
                        {
                            SettingsUnit.EditIntUnit(
                                title = stringResource(id = R.string.settings_title_max_pitch),
                                value = maxPitch,
                                valueRange = 1..50,
                                onValueChange = { value ->
                                    maxPitch = value
                        ...
                        {
                            SettingsUnit.EditIntUnit(
                                title = stringResource(id = R.string.settings_title_max_speech_rate),
                                value = maxSpeechRate,
                                valueRange = 1..50,
                                onValueChange = { value ->
                                    maxSpeechRate = value
                        ...
                        Column(modifier = Modifier
                            ...
                            OutlinedTextField(
                                ...
                                modifier = Modifier
                                    .fillMaxWidth()
                                    .onFocusChanged {
                                        Main.isTextFieldFocused = it.isFocused
                                    },
